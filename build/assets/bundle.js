...
if (_utils_nodes_js__WEBPACK_IMPORTED_MODULE_0__.nav) {
  ...
  const tl = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline().pause();
...
if (topBannerSlider) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](topBannerSlider, {
    slidesPerView: 1,
    spaceBetween: 40,
    pagination: {
...
if (reviewSlider) {
  const reviewSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](reviewSlider, {
    slidesPerView: 1,
    breakpoints: {
      767: {
        slidesPerView: 2
  ...
  if (tabs) {
    ...
    const onClickFillSwiper = evt => {
      ...
      const active = document.querySelector(".review-clients-tabs button.active");
      if (active === target) return;
      active.classList.remove("active");
      target.classList.add("active");
      if (type !== "all") {
        reviewCards.forEach(card => {
          card.dataset.type === type ? card.classList.remove("hidden") : card.classList.add("hidden");
        });
      } else {
        reviewCards.forEach(card => {
          card.classList.contains("hidden") ? card.classList.remove("hidden") : null;
        });
      }
      reviewSwiper.update();
    };
...
/***/ "./src/scripts/utils/custom-select.js":
/*!********************************************!*\
  !*** ./src/scripts/utils/custom-select.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
